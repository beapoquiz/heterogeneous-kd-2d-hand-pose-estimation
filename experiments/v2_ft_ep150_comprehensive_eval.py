...
print()
print('='*55)
print('DISTILLED V2 FT EPOCH 150 — FULL EVALUATION')
...
with open('results_distilled_v2_ft_epoch_150.txt', 'w') as f:
    f.write('Distilled v2 Fine-tuned Epoch 150 — Full Evaluation\n')
...
print('Saved: results_distilled_v2_ft_epoch_150.txt')
