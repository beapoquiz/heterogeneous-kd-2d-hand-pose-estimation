...
CHECKPOINT = os.path.join(BASE, 'checkpoints', 'distilled_v2_ft_epoch_150.pth')
...
print('Loading RHD fine-tuned student (Epoch 150)...')
...
while True:
    ...
    cv2.putText(frame, 'RHD Fine-tuned  |  Epoch 150  |  21 hand keypoints',
                (10, fh - 10), cv2.FONT_HERSHEY_SIMPLEX, 0.45, (180, 180, 180), 1)

    cv2.imshow('Hand Keypoint Demo — RHD Fine-tuned Epoch 150', frame)
