...
# Use SAME pipeline as direct supervision training
pipeline = [
    dict(type='LoadImage'),
...
print(f'Direct Supervision Comprehensive Eval — GT Reference')
...
print()
print('='*60)
print('DIRECT SUPERVISION BEST (Epoch 25) — GT REFERENCE EVALUATION')
print(f'Dataset: RHD test split ({N} samples)')
print('Reference: Raw GT annotations (same as training)')
print('='*60)
...
with open('results_direct_sup_GT.txt', 'w') as f:
    f.write('Direct Supervision Best (Epoch 25) — GT Reference\n')
...
print('Saved: results_direct_sup_GT.txt')