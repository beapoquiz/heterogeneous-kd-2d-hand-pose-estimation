...
print()
print('=' * 55)
print('FREIHAND FT EPOCH 50 — FULL EVALUATION')
...
with open('results_freihand_ft_epoch_50.txt', 'w') as f:
    f.write('FreiHAND Fine-Tuned Epoch 50 — Full Evaluation\n')
...
print('Saved: results_freihand_ft_epoch_50.txt')
