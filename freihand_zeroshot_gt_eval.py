...
# Zero-shot: FT V2-150 checkpoint (distilled_v2_ft, 100ep distill + 50ep RHD
# finetune) is evaluated directly on FreiHAND with NO FreiHAND fine-tuning.
...
print(f'Zero-Shot Eval — distilled_v2_ft_epoch_150.pth (RHD-trained, NO FreiHAND fine-tuning)')
print(f'Reference           : FreiHAND ground truth (RHD-style GT protocol)')
...
print()
print('=' * 55)
print('FT V2-150 ZERO-SHOT ON FREIHAND — GT EVALUATION')
print('Checkpoint: distilled_v2_ft_epoch_150.pth (RHD-trained only, no FreiHAND FT)')
...
with open('results_freihand_zeroshot_gt.txt', 'w') as f:
    f.write('FT V2-150 Zero-Shot on FreiHAND -- GT Evaluation\n')
    f.write('Checkpoint: checkpoints/distilled_v2_ft_epoch_150.pth (RHD-trained, NOT fine-tuned on FreiHAND)\n')
...
print('Saved: results_freihand_zeroshot_gt.txt')
