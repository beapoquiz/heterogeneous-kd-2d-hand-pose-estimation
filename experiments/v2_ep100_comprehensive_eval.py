...
print(f'Comprehensive Eval — distilled_v2_epoch_100.pth (Epoch 100)')
...
print()
print('='*55)
print('DISTILLED V2 EPOCH 100 — FULL EVALUATION')
...
with open('results_v2_epoch100.txt', 'w') as f:
    f.write('Distilled v2 Epoch 100 — Full Evaluation\n')
