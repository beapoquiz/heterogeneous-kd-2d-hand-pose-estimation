...
print()
print('=' * 55)
print('FREIHAND FT BEST — TEACHER COORD EVALUATION')
...
with open('results_freihand_ft_best_tc.txt', 'w') as f:
    f.write('FreiHAND Fine-Tuned Best — Teacher Coord Evaluation\n')
...
print('Saved: results_freihand_ft_best_tc.txt')
