...
student.load_state_dict(torch.load(
    'checkpoints/distilled_v2_best.pth', map_location=device))
student.eval()
...
print(f'Comprehensive Eval — distilled_v2_best.pth (Epoch 65)')
...
print()
print('='*55)
print('DISTILLED V2 BEST (Epoch 65) — FULL EVALUATION')
...
with open('results_v2_best_epoch65.txt', 'w') as f:
    f.write('Distilled v2 Best (Epoch 65) — Full Evaluation\n')
...
print('Saved: results_v2_best_epoch65.txt')